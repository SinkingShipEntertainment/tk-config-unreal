...
class MayaABCPublishPlugin(HookBaseClass):
    """
    ...
    def description(self):
        ...
        session geometry under the '|master|model' hierarchy will be exported
        to the path defined by this plugin's configured "Publish Template"
        setting. The plugin will fail to validate if the "AbcExport" plugin is
        not enabled or cannot be found, or if there is no '|master|model'
        hierarchy found..</p>
        """
    ...
    def settings(self):
        ...
        base_settings = super(MayaABCPublishPlugin, self).settings or {}
    ...
    def validate(self, settings, item):
        ...
        return super(MayaABCPublishPlugin, self).validate(settings, item)
    ...
    def publish(self, settings, item):
        ...
        super(MayaABCPublishPlugin, self).publish(settings, item)
